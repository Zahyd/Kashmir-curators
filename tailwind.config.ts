  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        kashmir: {
          teal: "hsl(var(--kashmir-teal))",
          "teal-light": "hsl(var(--kashmir-teal-light))",
          gold: "hsl(var(--kashmir-gold))",
          "gold-light": "hsl(var(--kashmir-gold-light))",
          snow: "hsl(var(--kashmir-snow))",
          pine: "hsl(var(--kashmir-pine))",
